...
const GlobalLayoutSection = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      {/* Video Background */}
      ...
      <div className="relative z-10 h-full flex items-center justify-center sm:justify-start">
        <motion.div
          ...
          className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 sm:p-8 lg:p-12 max-w-sm sm:max-w-md w-full"
        >
          {/* Title */}
          <motion.h2
          ...
          <motion.p
            ...
            className="text-white text-center mb-6 sm:mb-8 text-base sm:text-lg"
          >
          ...
          >
            <button
              ...
              className="w-full bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-left text-white placeholder-white/70 flex items-center justify-between hover:bg-white/20 transition-colors duration-300 text-sm sm:text-base"
            >
            ...
            {isContinentOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="absolute top-full left-0 right-0 mt-1 bg-white/10 backdrop-blur-sm border border-white/30 rounded-lg overflow-hidden z-20 max-h-40 overflow-y-auto"
              >
                {continents.map((continent) => (
                  <button
                    key={continent}
                    onClick={() => handleContinentSelect(continent)}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-left text-white hover:bg-white/20 transition-colors duration-200 text-sm sm:text-base"
                  >
                    {continent}
                  </button>
                ))}
          ...
          >
            <button
              ...
              className={`w-full backdrop-blur-sm border rounded-lg px-3 sm:px-4 py-2.5 sm:py-3 text-left flex items-center justify-between transition-colors duration-300 text-sm sm:text-base ${
                selectedContinent 
